...
keycodeMappingWin = {
    ...
    0x6a: 'multiply',  # VK_MULTIPLY  ??? ¿Es este el * del teclado numérico?
    0x6b: 'add',  # VK_ADD  ??? ¿Es este el + del teclado numérico?
    0x6c: 'separator',  # VK_SEPARATOR  ??? ¿Es este el enter del teclado numérico?
    0x6d: 'subtract',  # VK_SUBTRACT  ??? ¿Es este el - del teclado numérico?
