...
rmdir /s /q C:\developers\python\rmtDesk\bectrl\__pycache__
rmdir /s /q C:\developers\python\rmtDesk\ctrl\__pycache__

REM Configuracion de directorios
set SOURCE_DIR=%~dp0
set DEST1=D:\Users\Nico\Downloads\rmtDesk\
set DEST2=D:\shared\nico\Desktop\Netcool\Docs\2025\scripts\rmtDesk\
